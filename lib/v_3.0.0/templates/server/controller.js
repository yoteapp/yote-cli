...
exports.createSingle = async (req, res) => {
  const new__PascalName__ = new __PascalName__(req.body);
...
exports.updateSingleById = async (req, res) => {
  ...
  if(req.body?._id && req.body._id !== req.params.id) {
    throw new YoteError("Mismatched __PascalName__ Ids", 403);
  }
  ...
  // apply updates
  Object.assign(old__PascalName__, req.body);
...
exports.getDefault = async (req, res) => {
  ...
  if(!default__PascalName__) throw new YoteError("Could not find default __PascalName__", 404);
...
// FETCH UTILS
const utilFetch__PascalName__List = async ({ query, pagination, sort, limit, populate = '' }) => {
